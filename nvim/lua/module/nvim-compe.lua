...
remap('i', '<C-d>', [[compe#close('<C-e>')]], {expr = true, silent = true})
remap('i', '<C-f>', [[compe#scroll({ 'delta': +4 })]], {expr = true, silent = true})
remap('i', '<C-b>', [[compe#scroll({ 'delta': -4 })]], {expr = true, silent = true})
