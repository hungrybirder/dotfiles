...
mapper("n", "<F4>", '<cmd>lua require"dap".terminate()<CR>')
...
mapper("n", "<leader>dc", '<cmd>lua require"dap".terminate()<CR>')
mapper("n", "<leader>dr", '<cmd>lua require"dap".repl.toggle({}, "vsplit")<CR><C-w>l')
mapper("n", "<leader>di", '<cmd>lua require"dap.ui.variables".hover()<CR>')
mapper("n", "<leader>di", '<cmd>lua require"dap.ui.variables".visual_hover()<CR>')
mapper("n", "<leader>d?", '<cmd>lua require"dap.ui.variables".scopes()<CR>')
mapper("n", "<leader>de", '<cmd>lua require"dap".set_exception_breakpoints({"all"})<CR>')
mapper("n", "<leader>da", '<cmd>lua require"debugHelper".attach()<CR>')
mapper("n", "<leader>dA", '<cmd>lua require"debugHelper".attachToRemote()<CR>')
mapper("n", "<leader>di", '<cmd>lua require"dap.ui.widgets".hover()<CR>')
mapper("n", "<leader>d?", '<cmd>lua local widgets=require"dap.ui.widgets";widgets.centered_float(widgets.scopes)<CR>')
